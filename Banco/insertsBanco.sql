...
INSERT INTO revenue_tbl (cod_user_revenue, monthly_amount, extra_income) VALUES (1, 1880.00, 100.00);
...
INSERT INTO expenditure_tbl (name_expenditure, amount_expenditure, cod_user_expenditure, FK_type_expenditure) VALUES
("Internet", 100.00, 1, 1),
("Compra de Pizza", 54.00, 1, 2);
...
INNER JOIN users_tbl ON users_tbl.user_id = revenue_tbl.cod_user_revenue;
